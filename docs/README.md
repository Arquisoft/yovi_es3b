...
The deployment url is: [https://arquisoft.github.io/yovi_es3b/](https://arquisoft.github.io/yovi_es3b/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/yovi_es3b/](https://arquisoft.github.io/yovi_es3b/), we need to execute `npm run deploy`.
